...
final class DiscordGuildSuggestContentSlashCommandOption implements IDiscordSlashCommandOption {
	public static final String NAME = "content";

	private static final int CONTENT_LIMIT = 2000;

	public DiscordGuildSuggestContentSlashCommandOption() {
	}

	@Override
	public OptionData initDiscordSlashCommandOptionData() {
		return new OptionData(OptionType.STRING, NAME, "Content!")
