...
final class DiscordGuildJoinRoleSlashCommandOption implements IDiscordSlashCommandOption {
	public static final String NAME = "role";

	public DiscordGuildJoinRoleSlashCommandOption() {
	}

	@Override
	public OptionData initDiscordSlashCommandOptionData() {
		return new OptionData(OptionType.ROLE, NAME, "Join Role!", true);
	}
}
