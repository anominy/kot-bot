...
final class DiscordGuildPublishWebhookSubscribeSlashSubcommand extends DiscordAbstractGuildWebhookSubscribeSlashSubcommand<PublishWebhookEntity, IPublishWebhookService> {

	public DiscordGuildPublishWebhookSubscribeSlashSubcommand(
		...
		super(DiscordGuildPublishWebhookSlashSubcommandGroup.NAME, guildWebhookService, webhookService,
				ConfigEntity::getPublishWebhook, ConfigEntity::setPublishWebhook, PublishWebhookEntity::new);
	}

	@Override
	public SubcommandData initDiscordSlashSubcommandData() {
		return new SubcommandData(NAME, "Subscribe Publish Webhook!");
	}
}
