...
final class DiscordGuildWebhookChannelSlashCommandOption implements IDiscordSlashCommandOption {
	public static final String NAME = "channel";

	public DiscordGuildWebhookChannelSlashCommandOption() {
	}

	@Override
	public OptionData initDiscordSlashCommandOptionData() {
		return new OptionData(OptionType.CHANNEL,NAME, "Webhook Channel!", true)
