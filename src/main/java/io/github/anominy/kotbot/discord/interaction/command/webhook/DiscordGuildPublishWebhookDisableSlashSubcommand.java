...
final class DiscordGuildPublishWebhookDisableSlashSubcommand extends DiscordAbstractGuildWebhookDisableSlashSubcommand {

	public DiscordGuildPublishWebhookDisableSlashSubcommand(IGuildWebhookService guildWebhookService) {
	...
	public SubcommandData initDiscordSlashSubcommandData() {
		return new SubcommandData(NAME, "Disable Publish Webhook!");
	}
}
