...
final class DiscordGuildSuggestAttachmentSlashCommandOption implements IDiscordSlashCommandOption {
	public static final String NAME = "attachment";

	public DiscordGuildSuggestAttachmentSlashCommandOption() {
	}

	@Override
	public OptionData initDiscordSlashCommandOptionData() {
		return new OptionData(OptionType.ATTACHMENT, NAME, "Attachment!", true);
	}
}
