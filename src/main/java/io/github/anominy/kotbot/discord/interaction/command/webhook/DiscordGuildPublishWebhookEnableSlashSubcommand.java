...
final class DiscordGuildPublishWebhookEnableSlashSubcommand extends DiscordAbstractGuildWebhookEnableSlashSubcommand {

	public DiscordGuildPublishWebhookEnableSlashSubcommand(IGuildWebhookService guildWebhookService) {
	...
	public SubcommandData initDiscordSlashSubcommandData() {
		return new SubcommandData(NAME, "Enable Publish Webhook!");
	}
}
