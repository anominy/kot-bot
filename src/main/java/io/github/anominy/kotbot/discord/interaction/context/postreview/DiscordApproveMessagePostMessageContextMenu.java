...
@Component
public final class DiscordApproveMessagePostMessageContextMenu extends DiscordAbstractReviewMessagePostMessageContextMenu {

	public DiscordApproveMessagePostMessageContextMenu(
			@Qualifier(LocalBean.GUILD_REVIEW_SERVICE)
			IGuildReviewService guildReviewService
	) {
		super("Publish The Post", true, guildReviewService);
	}
}
