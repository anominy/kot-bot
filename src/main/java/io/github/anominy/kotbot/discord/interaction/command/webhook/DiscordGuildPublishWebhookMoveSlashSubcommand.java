...
final class DiscordGuildPublishWebhookMoveSlashSubcommand extends DiscordAbstractGuildWebhookMoveSlashSubcommand<PublishWebhookEntity, IPublishWebhookService> {

	public DiscordGuildPublishWebhookMoveSlashSubcommand(
		...
		super(DiscordGuildPublishWebhookSlashSubcommandGroup.NAME, guildWebhookService, webhookService,
				ConfigEntity::getPublishWebhook);
	}

	@Override
	public SubcommandData initDiscordSlashSubcommandData() {
		return new SubcommandData(NAME, "Move Publish Webhook!");
	}
}
