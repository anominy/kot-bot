...
public final class GuildWebhookUnsubscribeFromChannelInput<T extends WebhookEntity<?>, U extends IWebhookService<T>> {
	...
	private GuildWebhookUnsubscribeFromChannelInput(
			Guild guild,
			String webhookName,
			U webhookService,
	...
	public static final class Builder<T extends WebhookEntity<?>, U extends IWebhookService<T>> {
		...
		public GuildWebhookUnsubscribeFromChannelInput<T, U> build() {
			return new GuildWebhookUnsubscribeFromChannelInput<>(
					this.guild,
					this.webhookName,
					this.webhookService,
